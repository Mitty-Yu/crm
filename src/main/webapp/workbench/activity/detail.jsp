		...
		$.ajax({
			...
			success : function (data) {
				...
				if(data.success){
					...
					//删除成功后，找到需要删除的记录所在的div，将该div移除掉
					//找到删除记录所在的div
					$("#"+id).remove();
