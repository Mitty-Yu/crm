...
<script type="text/javascript">
	...
	$(function(){
		...
		//页面加载完毕后，展现该条线索关联的市场活动列表
		showActivityList();

		//为"关联市场活动"超链接绑定事件，打开关联市场活动的模态窗口
		...
		//为关联按钮绑定事件，执行市场活动和当前线索关联关系的添加操作
		$("#bundBtn").click(function () {
			...
			//肯定挑√了，1个或者多个√
				...
				//bund.do?cid=xxx&aid=xxx&aid=xxx&aid=xxx
		...
		$.ajax({
			...
			success : function (data) {
				...
				$.each(data,function (i,n) {
					...
					//将n中市场活动的id处理成为关联关系表的id，目的是为了解除关联
