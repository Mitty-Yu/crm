...
<script type="text/javascript">
	$(function(){
		...
		$("#toSearchActivityModalBtn").click(function () {
		...
		$("#convertBtn").click(function () {
			...
			/*
				...
				要为后台发出线索转换的请求，我们应该发送一个ajax请求呢？还是传统请求？
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<!--
			...
			最终表单提交的方式：
				...
				workbench/clue/convert.do?clueId=xxx&money=xxx&name=xxx&expectedDate=xxx.....
		...
		<form action="workbench/clue/convert.do" method="post" id="tranForm">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="toSearchActivityModalBtn" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
