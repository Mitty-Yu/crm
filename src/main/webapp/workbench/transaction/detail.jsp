...
<script type="text/javascript">
	...
	function changeIcon(listStage,a) {
		...
		/*alert("变更的阶段为："+currentStage);
		alert("变更阶段的可能性为："+currentPossibility);
		alert("变更的阶段的下标："+index);
		alert("前面正常阶段和后面丢失阶段的分界点下标为："+point);*/

		//如果当前阶段的可能性为0	 前面7个一定是黑圈 后两个一个是红叉，一个是黑叉
		...
		//如果当前阶段的的可能性不为0 前面7个有可能是 绿圈，绿色标记，黑圈 ，后两个一个定是黑叉
		}else{

			//遍历前7个 有可能是 绿圈，绿色标记，黑圈
			for(var i=0;i<point;i++){
...
<body>
	...
	<div style="position: relative; left: 40px; top: -50px;">
		...
		<%
			...
			//如果当前阶段的可能性不为0 前7个 绿圈，绿色标记，黑圈，后两个一定是黑叉
			}else{
